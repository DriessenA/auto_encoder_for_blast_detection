...
def parse_argmuments():
    parser = argparse.ArgumentParser(description="File, k, n and parameters")
    ...
    parser.add_argument(
        "-e", metavar="expression_file", help=("path to expression file")
    )
    ...
    parser.add_argument(
        "-m",
        metavar="meta_data",
        help="path meta data with time, fileID, patientID and cluster per cell",
        default=None,
    )

    parser.add_argument(
        "-l", metavar="file_labels", help="path to file labels of cells"
    )
